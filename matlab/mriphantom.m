...
%
%         A    a     b    x0    y0    phi   T1    T2      PD    d1 d2  d3   d4
%   
%        --------------------------------------------------------------
shep = [  1   .69   .92    0     0     0    .315  0.08    .062  0   0   0   0 
        -.98 .6624 .8740   0  -.0184   0    .47   0.1     .0875 0   0   0   0
        -.02 .1100 .3100  .22    0    -18   4.2   1.99   1.99   0   0   0   0
        -.02 .1600 .4100 -.22    0     18   4.2   1.99   1.99   0   0   0   0
         .01 .2100 .2500   0    .35    0    4.2   1.99   1.99   0   0   0   0
         .01 .0460 .0460   0    .1     0    4.2   1.99   1.99   0   0   0   0
         .01 .0460 .0460   0   -.1     0    .65    .1     .1    0   0   0   0
         .01 .0460 .0230 -.08  -.605   0    4.2   1.99   1.990  0   0   0   0
         .01 .0230 .0230   0   -.606   0    .65    .1     .1    0   0   0   0
         .01 .0230 .0460  .06  -.605   0    .78    .2     0     0   0   0   0];
...
%         A    a     b    x0    y0    phi  T1    T2     PD    d1   d2   d3   d4
%        --------------------------------------------------------------
toft = [  1   .69   .92    0     0     0   .315  0.08   .062   0    0    0    0
        -.8  .6624 .8740   0  -.0184   0  0.47   0.1    .0875  0    0    0    0
        -.2  .1100 .3100  .22    0    -18 4.2    1.99  1.99    0    0    0    0
        -.2  .1600 .4100 -.22    0     18 4.2    1.99  1.99    0    0    0    0
         .1  .2100 .2500   0    .35    0  4.2    1.99  1.99    0    0    0    0
         .1  .0460 .0460   0    .1     0  4.2    1.99  1.99    0    0    0    0
         .1  .0460 .0460   0   -.1     0   .65    .1    .1     0    0    0    0
         .1  .0460 .0230 -.08  -.605   0  4.2    1.99  1.99    0    0    0    0
         .1  .0230 .0230   0   -.606   0   .65    .1    .1     0    0    0    0
         .1  .0230 .0460  .06  -.605   0   .78    .2    0      0    0    0    0];
